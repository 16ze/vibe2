...
const FILTERS = [
  ...
  },
  {
    id: "lark",
    name: "Lark",
    style: { filter: "contrast(0.9) brightness(1.1) saturate(0.85)" },
  },
  {
    id: "reyes",
    name: "Reyes",
  ...
  },
  {
    ...
    name: "Juno",
    style: {
      filter: "contrast(1.2) brightness(1.1) saturate(1.4) sepia(0.05)",
    },
  },
  {
    id: "slumber",
    name: "Slumber",
    style: { filter: "brightness(1.05) saturate(0.66)" },
  },
  {
    id: "crema",
    name: "Crema",
    style: {
      filter: "contrast(0.95) brightness(1.04) saturate(0.9) sepia(0.15)",
    },
  },
  {
    id: "ludwig",
    name: "Ludwig",
    style: { filter: "contrast(1.05) brightness(1.05) saturate(1.2)" },
  },
  {
    id: "aden",
    name: "Aden",
    style: {
      filter:
        "brightness(1.15) saturate(0.85) hue-rotate(-20deg) contrast(0.9)",
    },
  },
  {
    id: "perpetua",
          ...
          >
            ...
            >
              {previewImage ? (
                ...
                <div
                  className="w-full h-full bg-gradient-to-br from-indigo-400 to-purple-500"
                  style={filter.style}
                />
              )}
            </div>
